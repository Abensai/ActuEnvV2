...
?>
    ...
    <input type="text" name="postal_code" id="postal_code" value="<?php echo $row['postal_code']; ?>" required pattern="[0-9]{5}" title="Entrez un code postal valide à 5 chiffres">
    ...
    <input type="tel" name="phone" id="phone" value="<?php echo $row['phone']; ?>" required pattern="[0-9]{10}" title="Entrez un numéro de téléphone valide à 10 chiffres">

    <label for="fax">Fax:</label>
    <input type="tel" name="fax" id="fax" value="<?php echo $row['fax']; ?>" pattern="[0-9]{10}" title="Entrez un numéro de fax valide à 10 chiffres">
